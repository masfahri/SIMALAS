                    ...
                    <div class="box">
                        ...
                        <div class="box-body no-padding mailbox-nav">
                            <ul class="nav nav-pills flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="collapse" data-target="#{{ $item->kd_kelas }}"><i
                                            class="fa fa-circle-o text-danger"></i>{{ $item->kd_kelas }}</a>
                                    <div id="{{ $item->kd_kelas }}" class="collapse">
                                        <ul>
                                            @foreach ($item->KelasSubJurusan as $items)
                                            <li><a href="{{ route('admin.master.jadwal.kelas', $items->id) }}">{{
                                                    $items->kd_kelas }} - {{ $items->kd_sub_kelas }}</a></li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </li>
